const avisoDeTela = `<div class="container d-lg-none text-center" id="celular">
      ...
      <div style="margin-top:.5rem; margin-bottom: 80px;">
        ...
        <p>
          <span style="font-family:Verdana;color: #fff; font-weight: bold;" size="3rem">Visualize este recurso em um computador, em janela com largura mínima de 992px.</span>
        </p>
      </div>
    </div>`;
